// Shared desktop brand sidebar for the interactive tools (Health Check,
...
const Logo = () => (
  <svg width="120" height="36" viewBox="0 0 134 40" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs><clipPath id="lbs"><rect width="134" height="40" fill="white"/></clipPath></defs>
  </svg>
);
...
export default function BrandSidebar({ title, blurb, step, progress = 0, bullets = [] }) {
  return (
    <aside className="wfm-brand">
      <div className="wfm-brand-inner">
        ...
        <p style={{ fontSize: 15, color: "#9DB9AE", lineHeight: 1.6, margin: "0 0 30px" }}>{blurb}</p>

        <div style={{ marginBottom: 30 }}>
          <div style={{ fontSize: 12, fontWeight: 700, color: "#63DB94", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: 9 }}>{step}</div>
