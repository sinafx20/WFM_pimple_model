...
const TESTIMONIALS = [
  {
    ...
    quote: "The data within WorkflowMAX helps me as the owner manage the profitability of projects from start to finish.",
    quoteName: "Kavan Applegate", quoteTitle: "Director",
  ...
  },
  {
    ...
    quote: "The big problem with Excel spreadsheets is it's not scalable. Implementing WorkflowMAX was painless and fast.",
    quoteName: "Luphus Oosthuizen", quoteTitle: "Director",
  ...
  },
  {
    ...
    quote: "With WorkflowMAX, we've been able to have real-time data, so we get a great picture on profit and understanding what our profit is.",
    quoteName: "Steve Luxmoore", quoteTitle: "Director",
  ...
  },
  {
    ...
    quote: "We needed a system that works in real time and shares visibility to decision makers so we can make those decisions really quickly. WorkflowMAX makes it really easy to do that.",
    quoteName: "Sarah No", quoteTitle: "Brand and Marketing Director",
